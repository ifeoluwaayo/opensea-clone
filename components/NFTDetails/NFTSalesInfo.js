...
const style = {
	...
	headerIcon: `h-6 w-6`,
	greyText: `text-gray-400 dark:text-gray-300`,
	...
	button: `flex w-[14rem] items-center cursor-pointer justify-center space-x-4 rounded-lg py-2 dark:text-white`,
	purchaseButton: `bg-blue-500 dark:bg-blue-700`,
	offerButton: `bg-[#363840] dark:bg-gray-700 border-black`,
	buttonIcon: `h-6 w-6`,
};
			...
			<div className={style.header}>
				<div className={style.headerContent}>
					...
					<div className={style.greyText}>
						Sales end August 1, 2022 at 8:20pm GMT+1
					</div>
